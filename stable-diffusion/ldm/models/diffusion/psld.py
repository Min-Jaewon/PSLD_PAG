...
class DDIMSampler(object):
    ...
    def ddim_sampling(self, cond, shape,
                      ...
                      unconditional_guidance_scale=1., unconditional_conditioning=None, pag_scale=0.0,
                      ip_mask = None, measurements = None, operator = None, gamma = 1, inpainting=False, omega=1,
                      general_inverse = None, noiser=None,
                      ffhq256=False):
        ...
        if inpainting:
            ...
            if unconditional_conditioning is None or unconditional_guidance_scale == 1.:
                ...
                # CFG(X) & PAG(O)   
                    ...
                    e_t_cond=self.model.apply_model(z_t, t, c) 
                    e_t_perturbed=self.model.apply_model(z_t, t, c, use_pag=True) 
                    e_t= e_t_cond + pag_scale * (e_t_cond-e_t_perturbed)
                ...
                # CFG(O) & PAG(O)
                    ...
                    e_t = e_t_uncond + unconditional_guidance_scale * (e_t_cond - e_t_uncond)
                    e_t_perturbed=self.model.apply_model(z_t, t, c, use_pag=True)
                    e_t = e_t + pag_scale * (e_t_cond-e_t_perturbed)
            ...
            ##############################################
            if pag_scale!=0.0 or unconditional_guidance_scale!=1.0: # predict z_0 with not guided epsilon
                pred_z_0_opt = (z_t - sqrt_one_minus_at * e_t_cond) / a_t.sqrt()
            else:
                pred_z_0_opt = pred_z_0
                
            image_pred = self.model.differentiable_decode_first_stage(pred_z_0_opt)
            ...
            inpaint_error = torch.linalg.norm(encoded_z_0 - pred_z_0_opt)
